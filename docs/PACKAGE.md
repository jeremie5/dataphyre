...
- `extra.dataphyre.release-manifest`: `RELEASE_MANIFEST.json` in a prepared public export root.
  The schema and human-readable contract live under `docs/`; the JSON manifest is generated by the release preparation process.
- `extra.dataphyre.agent-boundary`: machine-readable guidance that the default
  ...
  release validation, `dataphyre_mcp_verify_all`, hot-path benchmarks, and runtime-internal edits
