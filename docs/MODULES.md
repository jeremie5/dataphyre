...
- Bundled lexical moderation datasets are omitted from prepared public exports;
  applications provide moderation rulesets or classifier callbacks for their own
  deployment.
