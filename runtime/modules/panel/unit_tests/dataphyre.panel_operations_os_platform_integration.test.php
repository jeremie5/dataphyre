...
test('Operations OS composes optional marketplace trust services and detects split transparency graphs',static function(Context $t):void{
	...
	$verifier=new \Dataphyre\Panel\PanelPackageTransparencyVerifier($signatureVerifier,['example_public_log'],[],['allow_trust_on_first_use'=>true,'clock'=>$clock]);$operations=dp_panel_os_platform_config(str_repeat('t',48));$operations['marketplace_transparency_verifier']=$verifier;$operations['marketplace_clock']=$clock;
