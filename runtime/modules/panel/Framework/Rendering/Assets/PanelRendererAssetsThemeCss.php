...
body[data-dp-theme-effects~="brutalist"]{
	color-scheme:light;
	background:var(--dp-body_bg,#f4f1e8);
	...
	--dp-table-actions-min-width:224px;
	--dp-radius:0px;
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-filter-chips{
	border:2px solid var(--dp-brutalist-border);
	background:var(--dp-surface,#fffdf4);
	box-shadow:var(--dp-brutalist-shadow);
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-modal:before{
	height:8px;
	background:repeating-linear-gradient(90deg,var(--dp-primary-600,#2563eb) 0 24px,var(--dp-warning-500,#facc15) 24px 48px,var(--dp-danger-600,#dc2626) 48px 72px);
	opacity:1;
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-page-disabled{
	border:2px solid var(--dp-brutalist-border);
	background:var(--dp-control_bg,var(--dp-surface));
	color:var(--dp-text,#111);
	box-shadow:var(--dp-brutalist-shadow-soft);
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-button,
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-table-view.active{
	background:var(--dp-primary-600,#2563eb);
	color:#fff;
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-action-success{background:var(--dp-success-600,#16a34a);color:#fff}
body[data-dp-theme-effects~="brutalist"] .dp-panel-action-warning{background:var(--dp-warning-500,#facc15);color:#111}
body[data-dp-theme-effects~="brutalist"] .dp-panel-action-danger{background:var(--dp-danger-600,#dc2626);color:#fff}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-card:hover{
	...
	box-shadow:7px 7px 0 var(--dp-brutalist-border);
}
...
body[data-dp-theme-effects~="brutalist"] textarea{
	...
	background:var(--dp-control_bg,var(--dp-surface));
	color:var(--dp-text,#111);
	box-shadow:inset 3px 3px 0 color-mix(in srgb,var(--dp-brutalist-border) 10%,transparent);
}
...
body[data-dp-theme-effects~="brutalist"] [tabindex]:focus-visible{
	outline:0;
	box-shadow:var(--dp-brutalist-focus);
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-table th{
	background:var(--dp-neutral_bg,#e6e0cf);
	border-bottom:2px solid var(--dp-brutalist-border);
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-table tbody tr:nth-child(even) td{
	background:color-mix(in srgb,var(--dp-surface_muted,#ede8d8) 72%,var(--dp-surface));
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-table tbody tr:hover td{
	background:var(--dp-warning-100,#fef3c7);
	color:#111;
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-horizontal-group>summary:hover{
	border-color:var(--dp-brutalist-border);
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-commandbar,
body[data-dp-theme-effects~="brutalist"] .dp-panel-page-table{
	box-shadow:3px 3px 0 var(--dp-brutalist-border);
}
}
body[data-dp-theme-effects~="brutalist"]:before{
	content:"";
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-theme-select select{
	border:0;
	border-left:2px solid var(--dp-brutalist-border);
	border-radius:0;
	background:transparent;
	box-shadow:none;
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-density a.active{
	...
	box-shadow:2px 2px 0 var(--dp-brutalist-border);
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-commandbar{
	display:grid;
	gap:14px;
	padding:16px;
	background:linear-gradient(180deg,var(--dp-surface,#fffdf4),var(--dp-surface_muted,#ede8d8));
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-table th{
	...
	top:0;
	z-index:9;
	box-shadow:0 2px 0 var(--dp-brutalist-border);
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-table td.dp-panel-actions{
	border-left:2px solid var(--dp-brutalist-border);
	box-shadow:-4px 0 0 color-mix(in srgb,var(--dp-brutalist-border) 10%,transparent);
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-insight-success:after{background:var(--dp-success-600,#16a34a)}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-insight-warning:after{background:var(--dp-warning-500,#facc15)}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-insight-danger:after{background:var(--dp-danger-600,#dc2626)}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-insight-info:after{background:var(--dp-info-600,#0891b2)}
body[data-dp-theme-effects~="brutalist"] .dp-panel-modal{
	border-width:3px;
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-modal-header{
	border-bottom:3px solid var(--dp-brutalist-border);
	background:var(--dp-surface,#fffdf4);
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-modal-body{
	background:var(--dp-surface_muted,#ede8d8);
}
body[data-dp-theme-effects~="brutalist"] .dp-panel-modal-close{
	border:2px solid var(--dp-brutalist-border);
	background:var(--dp-danger-600,#dc2626);
	color:#fff;
	box-shadow:var(--dp-brutalist-shadow-soft);
}
...
body[data-dp-theme-effects~="brutalist"] .dp-panel-bulk-bar{
	border:3px solid var(--dp-brutalist-border);
	background:var(--dp-warning-500,#facc15);
	box-shadow:var(--dp-brutalist-shadow);
}
...
body[data-dp-theme-effects~="brutalist"]{
	--dp-radius:0px;
	--dp-nav-shell-radius:0px;
	--dp-nav-item-radius:0px;
	--dp-nav-radius:0px;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-main-region>header:before{height:3px;background:linear-gradient(90deg,color-mix(in srgb,var(--dp-glass-primary) 88%,transparent),color-mix(in srgb,var(--dp-glass-info) 82%,transparent),color-mix(in srgb,var(--dp-success-600,#16a34a) 62%,transparent));filter:drop-shadow(0 0 14px color-mix(in srgb,var(--dp-glass-info) 34%,transparent))}
...
body[data-dp-theme-effects~="glass"] .dp-panel-chart-grid{stroke:color-mix(in srgb,var(--dp-glass_border) 68%,transparent)}
body[data-dp-theme-effects~="glass"] .dp-panel-chart-area{opacity:.22}
...
body[data-dp-theme-effects~="glass"] .dp-panel-chart-ring-bg{stroke:color-mix(in srgb,var(--dp-glass_border) 72%,transparent)}
body[data-dp-theme-effects~="glass"] .dp-panel-tab-list,body[data-dp-theme-effects~="glass"] .dp-panel-step-list{border:1px solid var(--dp-glass_border);border-radius:999px;background:var(--dp-glass_surface_muted_bg);box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);padding:5px;backdrop-filter:var(--dp-glass_blur);-webkit-backdrop-filter:var(--dp-glass_blur)}
body[data-dp-theme-effects~="glass"] .dp-panel-tab-list button,body[data-dp-theme-effects~="glass"] .dp-panel-step-list button{border:1px solid transparent;background:transparent;color:var(--dp-text_muted);box-shadow:none}
body[data-dp-theme-effects~="glass"] .dp-panel-tab-list button[aria-selected=true],body[data-dp-theme-effects~="glass"] .dp-panel-step-list button[aria-current=step]{background:linear-gradient(135deg,var(--dp-primary-600,#2563eb),var(--dp-info-600,#0891b2));border-color:color-mix(in srgb,#fff 24%,transparent);color:#fff;box-shadow:0 14px 30px color-mix(in srgb,var(--dp-primary-600,#2563eb) 24%,transparent),inset 0 1px 0 rgba(255,255,255,.24)}
body[data-dp-theme-effects~="glass"] .dp-panel-table tbody tr:has(input[type=checkbox]:checked),body[data-dp-theme-effects~="glass"] .dp-panel-row-selected td{background:linear-gradient(90deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 18%,transparent),color-mix(in srgb,var(--dp-glass_surface_bg) 72%,transparent))}
body[data-dp-theme-effects~="glass"] .dp-panel-table [data-dp-panel-row]:focus-visible td,body[data-dp-theme-effects~="glass"] .dp-panel-table .dp-panel-row-focused td{background:linear-gradient(90deg,color-mix(in srgb,var(--dp-info-600,#0891b2) 18%,transparent),color-mix(in srgb,var(--dp-glass_surface_bg) 74%,transparent));box-shadow:inset 0 1px 0 color-mix(in srgb,var(--dp-glass_border) 72%,transparent),inset 0 -1px 0 color-mix(in srgb,var(--dp-glass_border) 62%,transparent)}
body[data-dp-theme-effects~="glass"] .dp-panel-search:focus-within,body[data-dp-theme-effects~="glass"] .dp-panel-global-search:focus-within,body[data-dp-theme-effects~="glass"] .dp-panel-table-scroll:focus,body[data-dp-theme-effects~="glass"] .dp-panel-field:focus-within{box-shadow:var(--dp-glass_focus);border-radius:calc(var(--dp-radius,16px) + 2px)}
...
body[data-dp-theme-effects~="glass"] .dp-panel-toast{border-color:color-mix(in srgb,var(--dp-glass-tone,var(--dp-glass-primary)) 30%,var(--dp-glass_border));background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass-tone,var(--dp-glass-primary)) 12%,transparent),var(--dp-glass_menu_bg))}
body[data-dp-theme-effects~="glass"] .dp-panel-toast-icon{background:color-mix(in srgb,var(--dp-glass-tone,var(--dp-glass-primary)) 18%,var(--dp-glass_control_bg));color:var(--dp-text);border:1px solid color-mix(in srgb,var(--dp-glass-tone,var(--dp-glass-primary)) 22%,var(--dp-glass_border))}
...
body[data-dp-theme-effects~="glass"] .dp-panel-empty-state{position:relative;overflow:hidden;border-color:var(--dp-glass_border);background:radial-gradient(circle at 20% 0,color-mix(in srgb,var(--dp-glass-info) 16%,transparent),transparent 18rem),var(--dp-glass_surface_muted_bg);box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);backdrop-filter:var(--dp-glass_blur);-webkit-backdrop-filter:var(--dp-glass_blur)}
...
body[data-dp-theme-effects~="glass"] .dp-panel-empty{border:1px dashed color-mix(in srgb,var(--dp-glass_border) 74%,transparent);border-radius:14px;background:var(--dp-glass_surface_muted_bg);padding:14px;box-shadow:var(--dp-glass_edge)}
...
body[data-dp-theme-effects~="glass"] .dp-panel-record-pulse-grid>*,body[data-dp-theme-effects~="glass"] .dp-panel-table-pulse-grid>*,body[data-dp-theme-effects~="glass"] .dp-panel-board-pulse-grid>*,body[data-dp-theme-effects~="glass"] .dp-panel-form-pulse-grid>*{background:var(--dp-glass_surface_muted_bg);border-color:var(--dp-glass_border);box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);backdrop-filter:var(--dp-glass_blur);-webkit-backdrop-filter:var(--dp-glass_blur)}
body[data-dp-theme-effects~="glass"] .dp-panel-record-pulse header,body[data-dp-theme-effects~="glass"] .dp-panel-table-pulse header,body[data-dp-theme-effects~="glass"] .dp-panel-board-pulse header,body[data-dp-theme-effects~="glass"] .dp-panel-form-pulse header{border-color:color-mix(in srgb,var(--dp-glass_border) 78%,transparent);background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass-info) 10%,transparent),transparent)}
body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-link.active,body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-submenu.active>summary,body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-link.active,body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-submenu.active>summary{box-shadow:var(--dp-glass_active_glow),inset 0 1px 0 rgba(255,255,255,.26)}
body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-link.active .dp-panel-sidebar-icon,body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-submenu.active>summary .dp-panel-sidebar-icon{box-shadow:inset 0 1px 0 rgba(255,255,255,.28),0 8px 20px rgba(15,23,42,.10)}
body[data-dp-theme-effects~="glass"] .dp-panel-table-can-scroll-left:before{background:linear-gradient(90deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 18%,transparent),transparent)}
body[data-dp-theme-effects~="glass"] .dp-panel-table-can-scroll-right:after{background:linear-gradient(270deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 18%,transparent),transparent)}
...
body[data-dp-theme-effects~="glass"] .dp-panel-column-resizer:hover:after,body.dp-panel-column-resizing[data-dp-theme-effects~="glass"] .dp-panel-column-resizer:after{background:var(--dp-glass-info);box-shadow:0 0 0 4px color-mix(in srgb,var(--dp-glass-info) 18%,transparent)}
body[data-dp-theme-effects~="glass"] .dp-panel-board-drop{outline:2px solid color-mix(in srgb,var(--dp-glass-success) 72%,transparent);outline-offset:3px;background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass-success) 16%,transparent),var(--dp-glass_surface_muted_bg));box-shadow:var(--dp-glass_active_glow)}
body[data-dp-theme-effects~="glass"] .dp-panel-board-drop-blocked{outline:2px solid color-mix(in srgb,var(--dp-glass-danger) 70%,transparent);outline-offset:3px;background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass-danger) 14%,transparent),var(--dp-glass_surface_muted_bg))}
body[data-dp-theme-effects~="glass"] .dp-panel-board-dragging{opacity:.72;transform:scale(.985) rotate(.35deg);box-shadow:var(--dp-glass_shadow_lifted)}
body[data-dp-theme-effects~="glass"] .dp-panel-relation{background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass-info) 8%,transparent),var(--dp-glass_surface_bg))}
body[data-dp-theme-effects~="glass"] .dp-panel-relation-aside,body[data-dp-theme-effects~="glass"] .dp-panel-relation-meta span,body[data-dp-theme-effects~="glass"] .dp-panel-relation-meta strong{background:var(--dp-glass_surface_muted_bg);border-color:var(--dp-glass_border);box-shadow:var(--dp-glass_edge)}
body[data-dp-theme-effects~="glass"] .dp-panel-filter-chip{background:var(--dp-glass_control_bg);border-color:var(--dp-glass_border);box-shadow:var(--dp-glass_edge)}
body[data-dp-theme-effects~="glass"] .dp-panel-filter-chip small{color:var(--dp-primary-700,#175cd3)}
body[data-dp-theme-effects~="glass"] .dp-panel-breadcrumbs a:hover{background:var(--dp-glass_control_bg);box-shadow:var(--dp-glass_edge)}
...
body[data-dp-theme-effects~="glass"] .dp-panel-row-more-floating .dp-panel-row-more-menu{
	position:fixed;
	left:var(--dp-row-menu-left);
	top:var(--dp-row-menu-top);
	width:var(--dp-row-menu-width);
	max-height:var(--dp-row-menu-max-height);
	overflow:auto;
	z-index:2147483000;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-action-group[open]>summary.dp-panel-action-primary:not(.dp-panel-action-disabled){
	background:linear-gradient(135deg,var(--dp-primary-600,#2563eb),var(--dp-info-600,#0891b2));
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 78%,#fff 12%);
	color:#fff;
	box-shadow:0 14px 34px color-mix(in srgb,var(--dp-primary-600,#2563eb) 24%,transparent),var(--dp-glass_edge);
	text-shadow:none;
}
body[data-dp-theme-effects~="glass"] .dp-panel-action-group[open]>summary.dp-panel-action-primary *,
...
body[data-dp-theme-effects~="glass"] .dp-panel-action-menu .dp-panel-action-success,
body[data-dp-theme-effects~="glass"] .dp-panel-row-more-menu .dp-panel-action-success{
	background:var(--dp-success-800,#085d3a);
	color:#fff;
}
body[data-dp-theme-effects~="glass"] .dp-panel-action-menu .dp-panel-action-info,
body[data-dp-theme-effects~="glass"] .dp-panel-row-more-menu .dp-panel-action-info{
	background:var(--dp-info-800,#065986);
	color:#fff;
}
body[data-dp-theme-effects~="glass"] :is(.dp-panel-action-menu,.dp-panel-row-more-menu) :is(.dp-panel-action-success,.dp-panel-action-info) .dp-panel-action-description{
...
body[data-dp-theme-effects~="glass"] .dp-panel-row-more-menu .dp-panel-row-link:focus-visible{
	background:linear-gradient(135deg,rgba(255,255,255,.96),rgba(232,240,252,.9));
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 24%,var(--dp-glass_border));
	color:#0f172a;
	box-shadow:0 8px 20px rgba(15,23,42,.10),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-row-more-menu .dp-panel-action-info:focus-visible{
	background:linear-gradient(135deg,var(--dp-info-800,#065986),color-mix(in srgb,var(--dp-info-800,#065986) 78%,var(--dp-primary-700,#1d4ed8)));
	border-color:color-mix(in srgb,var(--dp-info-600,#0891b2) 78%,#fff 12%);
	color:#fff;
}
body[data-dp-theme-effects~="glass"] .dp-panel-action-menu .dp-panel-action-info:hover *,
body[data-dp-theme-effects~="glass"] .dp-panel-action-menu .dp-panel-action-info:focus-visible *,
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-row-more-menu .dp-panel-row-link:focus-visible{
	background:linear-gradient(135deg,rgba(51,65,85,.94),rgba(15,23,42,.82));
	border-color:color-mix(in srgb,var(--dp-primary-500,#3b82f6) 34%,var(--dp-glass_border));
	color:#fff;
}
@media(prefers-color-scheme:dark){
...
body[data-dp-theme-effects~="glass"] .dp-panel-modal-header-actions>button{
	color:var(--dp-text,#0f172a);
	border-color:color-mix(in srgb,var(--dp-glass_border) 72%,var(--dp-text) 18%);
	text-shadow:none;
}
...
body[data-dp-theme-mode="light"][data-dp-theme-effects~="glass"] .dp-panel-modal-header-actions>button{
	...
	box-shadow:0 8px 24px rgba(15,23,42,.075),var(--dp-glass_edge);
}
...
body[data-dp-theme-mode="light"][data-dp-theme-effects~="glass"] .dp-panel-modal .dp-panel-row-link{
	color:#1d2939;
	background:linear-gradient(135deg,rgba(255,255,255,.96),rgba(242,246,252,.86));
	border-color:#cbd5e1;
	box-shadow:0 10px 28px rgba(15,23,42,.10),inset 0 0 0 1px rgba(255,255,255,.52);
	text-shadow:none;
}
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-modal-header-actions>button{
	...
	background:linear-gradient(135deg,rgba(51,65,85,.86),rgba(15,23,42,.68));
}
@media(prefers-color-scheme:dark){
...
body[data-dp-theme-effects~="glass"] .dp-panel-table-views{
	...
	overflow-y:hidden;
	flex-wrap:nowrap;
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 70%,transparent);
	border-radius:999px;
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 54%,transparent);
...
body[data-dp-theme-effects~="glass"] .dp-panel-table-view{
	...
	padding:0 12px;
	background:transparent;
	color:var(--dp-text_muted,#475467);
	box-shadow:none;
}
body[data-dp-theme-effects~="glass"] .dp-panel-table-view.active{
	background:linear-gradient(135deg,var(--dp-primary-600,#2563eb),color-mix(in srgb,var(--dp-primary-600,#2563eb) 72%,var(--dp-info-600,#0891b2)));
	border-color:transparent;
	color:#fff;
	box-shadow:0 10px 24px color-mix(in srgb,var(--dp-primary-600,#2563eb) 22%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-saved-view-menu>div{
	color:var(--dp-text,#0f172a);
	background:color-mix(in srgb,var(--dp-glass_menu_bg,var(--dp-surface)) 86%,var(--dp-surface));
	border-color:color-mix(in srgb,var(--dp-glass_border) 78%,var(--dp-text) 10%);
	box-shadow:0 24px 70px rgba(15,23,42,.20),var(--dp-glass_edge);
...
body[data-dp-theme-effects~="glass"] .dp-panel-row-more-menu button:hover{
	background:color-mix(in srgb,var(--dp-primary-600,#2563eb) 12%,var(--dp-surface));
}
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-table-view,
...
body[data-dp-theme-effects~="glass"] .dp-panel-pagination{
	color:var(--dp-text_muted,#475569);
}
body[data-dp-theme-effects~="glass"] .dp-panel-table{
	background:color-mix(in srgb,var(--dp-surface) 86%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-table tbody tr{
	background:color-mix(in srgb,var(--dp-surface) 76%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-table tbody tr:nth-child(even){
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 62%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-table-scroll tr:hover td.dp-panel-actions{
	background:linear-gradient(90deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 10%,transparent),color-mix(in srgb,var(--dp-surface) 88%,transparent));
}
body[data-dp-theme-effects~="glass"] input::placeholder,
body[data-dp-theme-effects~="glass"] textarea::placeholder{
	color:color-mix(in srgb,var(--dp-text_muted,#64748b) 82%,transparent);
	opacity:1;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-widget-icon{
	color:color-mix(in srgb,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)) 70%,var(--dp-text_muted));
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-widget-icon[data-dp-panel-icon="activity"]:before{
	...
	border:0;
	border-radius:0;
	background:linear-gradient(90deg,transparent 0 16%,currentColor 16% 28%,transparent 28% 40%,currentColor 40% 52%,transparent 52% 64%,currentColor 64% 76%,transparent 76%);
	clip-path:polygon(0 60%,18% 60%,28% 10%,42% 92%,55% 36%,68% 60%,100% 60%,100% 74%,62% 74%,55% 58%,42% 100%,27% 34%,21% 74%,0 74%);
}
body[data-dp-theme-effects~="glass"] .dp-panel-commandbar{
	border-color:color-mix(in srgb,var(--dp-glass_border) 82%,var(--dp-primary-600,#2563eb) 10%);
	background:radial-gradient(circle at 8% 0,color-mix(in srgb,var(--dp-glass-primary) 13%,transparent),transparent 18rem),linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_strong_bg) 86%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 74%,transparent));
	box-shadow:0 22px 70px color-mix(in srgb,var(--dp-glass-primary) 10%,rgba(15,23,42,.10)),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-table-controls{
	border-color:color-mix(in srgb,var(--dp-glass_border) 70%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-commandbar .dp-panel-per-page select{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 86%,var(--dp-surface) 14%);
	border-color:color-mix(in srgb,var(--dp-glass_border) 72%,var(--dp-text) 10%);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 24%,transparent),0 10px 26px rgba(15,23,42,.055);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-commandbar .dp-panel-action{
	...
	box-shadow:0 14px 34px color-mix(in srgb,currentColor 14%,transparent),inset 0 1px 0 rgba(255,255,255,.18);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-commandbar .dp-panel-column-picker summary{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 78%,var(--dp-surface) 22%);
	color:var(--dp-text,#0f172a);
	box-shadow:0 10px 24px rgba(15,23,42,.065),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-density,
body[data-dp-theme-effects~="glass"] .dp-panel-table-groups,
body[data-dp-theme-effects~="glass"] .dp-panel-table-meta,
body[data-dp-theme-effects~="glass"] .dp-panel-pagination{
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 72%,transparent);
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 68%,transparent);
...
body[data-dp-theme-effects~="glass"] .dp-panel-saved-view-menu>summary{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 82%,var(--dp-surface) 18%);
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
...
body[data-dp-theme-effects~="glass"] .dp-panel-bulk-bar{
	position:relative;
	overflow:hidden;
	border:1px solid color-mix(in srgb,var(--dp-primary-600,#2563eb) 22%,var(--dp-glass_border));
	border-radius:22px;
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 10%,transparent),var(--dp-glass_surface_strong_bg));
	box-shadow:0 18px 52px color-mix(in srgb,var(--dp-primary-600,#2563eb) 12%,transparent),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-filter-panel{
	border-color:color-mix(in srgb,var(--dp-glass_border) 82%,var(--dp-info-600,#0891b2) 10%);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_strong_bg) 86%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 78%,transparent));
	box-shadow:0 16px 44px rgba(15,23,42,.10),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-filter-panel>summary{
	color:var(--dp-text,#0f172a);
	background:color-mix(in srgb,var(--dp-glass_control_bg) 72%,transparent);
	border-color:color-mix(in srgb,var(--dp-glass_border) 72%,transparent);
	box-shadow:var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-filters{
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 74%,transparent);
	border-color:color-mix(in srgb,var(--dp-glass_border) 70%,transparent);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 18%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-modal{
	border-color:color-mix(in srgb,var(--dp-glass_border) 82%,var(--dp-primary-600,#2563eb) 8%);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_strong_bg) 88%,transparent),color-mix(in srgb,var(--dp-glass_surface_bg) 82%,transparent));
	box-shadow:0 36px 120px rgba(15,23,42,.34),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-header{
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_strong_bg) 88%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 70%,transparent));
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-modal-close{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 88%,var(--dp-surface) 12%);
	color:var(--dp-text,#0f172a);
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 78%,transparent);
	box-shadow:0 10px 26px rgba(15,23,42,.10),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-close:hover{
	background:color-mix(in srgb,var(--dp-danger-600,#dc2626) 12%,var(--dp-glass_control_bg));
	color:var(--dp-danger-700,#b42318);
}
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-modal-close{
	color:#f8fafc;
	background:linear-gradient(135deg,rgba(51,65,85,.84),rgba(15,23,42,.64));
}
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-modal-close:hover{
	color:#fecaca;
	background:linear-gradient(135deg,rgba(127,29,29,.74),rgba(15,23,42,.64));
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-nav{
	border-color:color-mix(in srgb,var(--dp-glass_border) 82%,var(--dp-primary-600,#2563eb) 8%);
	background:radial-gradient(circle at 18% 0,color-mix(in srgb,var(--dp-glass-primary) 12%,transparent),transparent 15rem),linear-gradient(180deg,color-mix(in srgb,var(--dp-glass_surface_strong_bg) 90%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 72%,transparent));
	box-shadow:0 22px 70px color-mix(in srgb,var(--dp-glass-primary) 9%,rgba(15,23,42,.12)),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-search input{
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,var(--dp-primary-600,#2563eb) 8%);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 84%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 60%,transparent));
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 20%,transparent),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-top [data-dp-panel-sidebar-toggle]{
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
	background:color-mix(in srgb,var(--dp-glass_control_bg) 82%,transparent);
	box-shadow:var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-group{
	border-top-color:color-mix(in srgb,var(--dp-glass_border) 62%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-nav-sidebar .dp-panel-sidebar-group h2 button{
	color:color-mix(in srgb,var(--dp-text_muted,#64748b) 86%,var(--dp-text) 14%);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-submenu>summary{
	border-color:color-mix(in srgb,var(--dp-glass_border) 42%,transparent);
	background:color-mix(in srgb,var(--dp-glass_control_bg) 30%,transparent);
	box-shadow:none;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-submenu>summary:hover{
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,var(--dp-primary-600,#2563eb) 12%);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 78%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 52%,transparent));
...
body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-submenu.active>summary{
	...
	background:linear-gradient(135deg,var(--dp-primary-600,#2563eb),color-mix(in srgb,var(--dp-primary-600,#2563eb) 70%,var(--dp-info-600,#0891b2)));
	color:#fff;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-horizontal-icon{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 78%,var(--dp-primary-600,#2563eb) 8%);
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 70%,transparent);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 18%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-page-disabled{
	color:var(--dp-text,#0f172a);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 88%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 56%,transparent));
	border-color:color-mix(in srgb,var(--dp-glass_border) 72%,transparent);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 18%,transparent),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-filter-chips{
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 60%,transparent);
	border-radius:18px;
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 52%,transparent);
	padding:10px;
	box-shadow:var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-theme-preset{
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 66%,transparent);
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-live-control button{
	color:var(--dp-text_muted,#64748b);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-live-control button[aria-pressed=true]{
	background:linear-gradient(135deg,var(--dp-primary-600,#2563eb),color-mix(in srgb,var(--dp-primary-600,#2563eb) 72%,var(--dp-info-600,#0891b2)));
	color:#fff;
	box-shadow:0 10px 24px color-mix(in srgb,var(--dp-primary-600,#2563eb) 24%,transparent),inset 0 1px 0 rgba(255,255,255,.24);
}
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-page-disabled{
	color:#f8fafc;
	background:linear-gradient(135deg,rgba(51,65,85,.80),rgba(15,23,42,.58));
}
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-theme-select select{
	color:#f8fafc;
	background:linear-gradient(135deg,rgba(51,65,85,.82),rgba(15,23,42,.62));
}
@media(prefers-color-scheme:dark){
...
body[data-dp-theme-effects~="glass"] .dp-panel-attachment-form input[type=file]{
	border-color:color-mix(in srgb,var(--dp-glass_border) 78%,var(--dp-text) 8%);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 88%,var(--dp-surface) 12%),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 54%,var(--dp-surface) 18%));
	color:var(--dp-text,#0f172a);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 26%,transparent),0 10px 24px rgba(15,23,42,.045);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-message-form textarea:focus{
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 58%,var(--dp-glass_border));
	background:color-mix(in srgb,var(--dp-glass_control_bg) 92%,var(--dp-surface) 8%);
	box-shadow:var(--dp-glass_focus),inset 0 1px 0 color-mix(in srgb,#fff 28%,transparent);
}
...
body[data-dp-theme-effects~="glass"] input[type=radio]{
	accent-color:var(--dp-primary-600,#2563eb);
...
body[data-dp-theme-effects~="glass"] .dp-panel-column-picker label:hover{
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 12%,var(--dp-glass_control_bg)),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 78%,transparent));
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 18%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-table th,
body[data-dp-theme-effects~="glass"] .dp-panel-table td{
	border-bottom-color:color-mix(in srgb,var(--dp-glass_border) 58%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-table th+th,
body[data-dp-theme-effects~="glass"] .dp-panel-table td+td{
	border-left:1px solid color-mix(in srgb,var(--dp-glass_border) 22%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-sort:hover{
	color:var(--dp-primary-700,#175cd3);
	background:color-mix(in srgb,var(--dp-primary-600,#2563eb) 9%,transparent);
	padding-inline:7px;
	margin-inline:-7px;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-row-preview dl div{
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 84%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 56%,transparent));
	box-shadow:var(--dp-glass_edge);
}
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-attachment-form input[type=file]{
	color:#f8fafc;
	background:linear-gradient(135deg,rgba(51,65,85,.84),rgba(15,23,42,.62));
...
body[data-dp-theme-effects~="glass"] .dp-panel-alert-card:after{
	...
	background:linear-gradient(135deg,rgba(255,255,255,.24),transparent 32%,rgba(255,255,255,.08) 64%,transparent);
	opacity:.58;
...
body[data-dp-theme-effects~="glass"] .dp-panel-chart,
body[data-dp-theme-effects~="glass"] .dp-panel-chart-card{
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 76%,var(--dp-info-600,#0891b2) 10%);
	border-radius:20px;
	background:radial-gradient(circle at 12% 0,color-mix(in srgb,var(--dp-info-600,#0891b2) 13%,transparent),transparent 16rem),linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 86%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 62%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-board-column{
	border-radius:20px;
	background:linear-gradient(180deg,color-mix(in srgb,var(--dp-glass_surface_bg) 78%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 66%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
body[data-dp-theme-effects~="glass"] .dp-panel-board-column>header{
	border-bottom:1px solid color-mix(in srgb,var(--dp-glass_border) 62%,transparent);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 64%,transparent),transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-board-card{
	border-color:color-mix(in srgb,var(--dp-glass_border) 74%,transparent);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 72%,var(--dp-surface) 12%),color-mix(in srgb,var(--dp-glass_surface_bg) 58%,transparent));
	box-shadow:0 10px 24px rgba(15,23,42,.07),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
body[data-dp-theme-effects~="glass"] .dp-panel-board-card:hover{
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 30%,var(--dp-glass_border));
	box-shadow:0 18px 38px color-mix(in srgb,var(--dp-primary-600,#2563eb) 12%,rgba(15,23,42,.08)),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-modal-status{
	margin:0 0 12px;
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
	border-radius:14px;
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 78%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
	color:var(--dp-text,#0f172a);
	box-shadow:var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-status-success{border-color:color-mix(in srgb,var(--dp-success-600,#16a34a) 36%,var(--dp-glass_border));background:linear-gradient(135deg,color-mix(in srgb,var(--dp-success-600,#16a34a) 14%,transparent),var(--dp-glass_surface_muted_bg))}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-status-warning{border-color:color-mix(in srgb,var(--dp-warning-600,#d97706) 36%,var(--dp-glass_border));background:linear-gradient(135deg,color-mix(in srgb,var(--dp-warning-600,#d97706) 14%,transparent),var(--dp-glass_surface_muted_bg))}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-status-error{border-color:color-mix(in srgb,var(--dp-danger-600,#dc2626) 36%,var(--dp-glass_border));background:linear-gradient(135deg,color-mix(in srgb,var(--dp-danger-600,#dc2626) 14%,transparent),var(--dp-glass_surface_muted_bg))}
...
body[data-dp-theme-effects~="glass"] .dp-panel-form-pulse{
	border-color:color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 74%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-form-pulse-grid>*{
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 72%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-column-picker summary:after{
	...
	inset:0;
	pointer-events:none;
	background:linear-gradient(135deg,rgba(255,255,255,.28),transparent 38%,rgba(255,255,255,.08));
	opacity:.44;
}
body[data-dp-theme-effects~="glass"] .dp-panel-button>*,
body[data-dp-theme-effects~="glass"] .dp-panel-action>*,
...
body[data-dp-theme-effects~="glass"] .dp-panel-column-picker summary:active{
	...
	box-shadow:inset 0 2px 8px rgba(15,23,42,.12),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] [data-dp-panel-step-disabled="1"]{
	...
	opacity:.58;
	filter:saturate(.72);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 14%,transparent),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-action-loading:before{
	...
	border-radius:999px;
	animation:dp-panel-glass-spin .75s linear infinite;
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-step-list button:hover{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 76%,transparent);
	color:var(--dp-text,#0f172a);
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 18%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-table-group-link.active{
	background:linear-gradient(135deg,var(--dp-primary-600,#2563eb),color-mix(in srgb,var(--dp-primary-600,#2563eb) 72%,var(--dp-info-600,#0891b2)));
	color:#fff;
	box-shadow:0 12px 26px color-mix(in srgb,var(--dp-primary-600,#2563eb) 24%,transparent),inset 0 1px 0 rgba(255,255,255,.24);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-row-selected td{
	border-bottom-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 24%,var(--dp-glass_border));
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 16%,transparent),inset 3px 0 0 var(--dp-primary-600,#2563eb);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-board-drop:before{color:var(--dp-success-600,#16a34a)}
body[data-dp-theme-effects~="glass"] .dp-panel-board-drop-blocked:before{color:var(--dp-danger-600,#dc2626)}
...
body[data-dp-theme-effects~="glass"] .dp-panel-relation{
	position:relative;
	overflow:hidden;
	border-color:color-mix(in srgb,var(--dp-glass_border) 78%,var(--dp-info-600,#0891b2) 8%);
	border-radius:20px;
	background:radial-gradient(circle at 10% 0,color-mix(in srgb,var(--dp-info-600,#0891b2) 9%,transparent),transparent 18rem),linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 84%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 64%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-relation-header{
	border-bottom-color:color-mix(in srgb,var(--dp-glass_border) 64%,transparent);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 62%,transparent),transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-relation-aside{
	border-color:color-mix(in srgb,var(--dp-glass_border) 74%,transparent);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 74%,var(--dp-surface) 10%),color-mix(in srgb,var(--dp-glass_surface_bg) 56%,transparent));
	box-shadow:0 10px 24px rgba(15,23,42,.055),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-task:hover{
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 26%,var(--dp-glass_border));
	box-shadow:0 14px 32px color-mix(in srgb,var(--dp-primary-600,#2563eb) 10%,rgba(15,23,42,.06)),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-attachment-form{
	border-top-color:color-mix(in srgb,var(--dp-glass_border) 68%,transparent);
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 62%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-body[data-dp-panel-modal-content="confirmation"]{
	padding:clamp(16px,2.2vw,24px);
	background:linear-gradient(180deg,color-mix(in srgb,var(--dp-glass_surface_muted_bg) 74%,transparent),color-mix(in srgb,var(--dp-glass_surface_bg) 76%,transparent));
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-confirmation{
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 76%,transparent);
	border-radius:20px;
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 88%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 64%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
...
body[data-dp-theme-effects~="glass"] .dp-panel-modal-confirmation .dp-panel-modal-actions{
	...
	border-top-color:color-mix(in srgb,var(--dp-glass_border) 78%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-confirmation-icon{
	background:color-mix(in srgb,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)) 18%,var(--dp-glass_control_bg));
	border:1px solid color-mix(in srgb,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)) 28%,var(--dp-glass_border));
	box-shadow:var(--dp-glass_edge);
}
...
@media(max-width:685px){body[data-dp-theme-effects~="glass"] .dp-panel-modal-body[data-dp-panel-modal-content="confirmation"]{padding:12px}body[data-dp-theme-effects~="glass"] .dp-panel-modal-confirmation{padding:16px}}
...
body[data-dp-theme-effects~="glass"] .dp-panel-custom-page h2{
	color:var(--dp-text,#0f172a);
	text-shadow:0 1px 0 color-mix(in srgb,var(--dp-surface) 34%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-search-result{
	...
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 84%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-search-result:before{
	...
	pointer-events:none;
	border-radius:inherit;
	background:linear-gradient(135deg,rgba(255,255,255,.22),transparent 34%,rgba(255,255,255,.06));
	opacity:.58;
	mix-blend-mode:soft-light;
}
body[data-dp-theme-effects~="glass"] .dp-panel-card>*,
...
body[data-dp-theme-effects~="glass"] .dp-panel-search-result:hover{
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 28%,var(--dp-glass_border));
	box-shadow:0 18px 42px color-mix(in srgb,var(--dp-primary-600,#2563eb) 10%,rgba(15,23,42,.08)),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-show{
	border-color:color-mix(in srgb,var(--dp-glass_border) 78%,var(--dp-primary-600,#2563eb) 8%);
	background:radial-gradient(circle at 16% 0,color-mix(in srgb,var(--dp-primary-600,#2563eb) 9%,transparent),transparent 18rem),linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_bg) 86%,transparent),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-table td:before{
	color:color-mix(in srgb,var(--dp-text_muted,#64748b) 88%,var(--dp-text) 12%);
	font-weight:900;
...
body[data-dp-theme-effects~="glass"] .dp-panel-command{
	border-color:color-mix(in srgb,var(--dp-glass_border) 84%,var(--dp-primary-600,#2563eb) 12%);
	background:radial-gradient(circle at 18% 0,color-mix(in srgb,var(--dp-primary-600,#2563eb) 12%,transparent),transparent 18rem),linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_surface_strong_bg) 90%,transparent),color-mix(in srgb,var(--dp-glass_surface_bg) 78%,transparent));
	box-shadow:0 34px 110px rgba(15,23,42,.28),var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-command input{
	border-color:color-mix(in srgb,var(--dp-glass_border) 78%,var(--dp-primary-600,#2563eb) 12%);
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass_control_bg) 90%,var(--dp-surface) 10%),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
	box-shadow:inset 0 1px 0 color-mix(in srgb,#fff 26%,transparent),0 12px 28px rgba(15,23,42,.07);
	color:var(--dp-text,#0f172a);
}
body[data-dp-theme-effects~="glass"] .dp-panel-command-context,
body[data-dp-theme-effects~="glass"] .dp-panel-command-footer{
	color:var(--dp-text_muted,#475569);
	border-color:color-mix(in srgb,var(--dp-glass_border) 62%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-command-list{
	border-radius:18px;
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 44%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-command-item{
	border-color:color-mix(in srgb,var(--dp-glass_border) 58%,transparent);
	background:color-mix(in srgb,var(--dp-glass_control_bg) 28%,transparent);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-command-item[aria-selected=true]{
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 30%,var(--dp-glass_border));
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 12%,var(--dp-glass_control_bg)),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 72%,transparent));
	box-shadow:var(--dp-glass_shadow_soft),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-toast{
	border-radius:18px;
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)) 12%,transparent),color-mix(in srgb,var(--dp-glass_menu_bg) 88%,var(--dp-surface) 12%));
	box-shadow:0 20px 70px rgba(15,23,42,.24),var(--dp-glass_edge);
...
body[data-dp-theme-effects~="glass"] .dp-panel-toast-progress{
	background:linear-gradient(90deg,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)),color-mix(in srgb,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)) 60%,#fff));
	box-shadow:0 0 18px color-mix(in srgb,var(--dp-glass-tone,var(--dp-primary-600,#2563eb)) 34%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-modal-body>.dp-panel-form>.dp-panel-toolbar:last-child,
body[data-dp-theme-effects~="glass"] .dp-panel-modal-body .dp-panel-form>.dp-panel-toolbar:last-child{
	border-top:1px solid color-mix(in srgb,var(--dp-glass_border) 70%,transparent);
	background:linear-gradient(180deg,color-mix(in srgb,var(--dp-glass_surface_muted_bg) 54%,transparent),color-mix(in srgb,var(--dp-glass_surface_strong_bg) 86%,transparent));
	box-shadow:0 -18px 44px rgba(15,23,42,.08),var(--dp-glass_edge);
	backdrop-filter:var(--dp-glass_blur);
	-webkit-backdrop-filter:var(--dp-glass_blur);
}
body[data-dp-theme-effects~="glass"] .dp-panel-bulk-bar{
...
body[data-dp-theme-effects~="glass"] .dp-panel-bulk-bar:after{
	...
	pointer-events:none;
	border-radius:inherit;
	background:linear-gradient(135deg,rgba(255,255,255,.20),transparent 40%,rgba(255,255,255,.06));
	opacity:.58;
}
body[data-dp-theme-effects~="glass"] .dp-panel-bulk-bar>*{
	position:relative;
...
body[data-dp-theme-effects~="glass"] .dp-panel-column-picker[open]>summary,
body[data-dp-theme-effects~="glass"] .dp-panel-saved-view-menu[open]>summary{
	border-color:color-mix(in srgb,var(--dp-primary-600,#2563eb) 34%,var(--dp-glass_border));
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 10%,var(--dp-glass_control_bg)),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 70%,transparent));
	box-shadow:var(--dp-glass_active_glow),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-saved-view-menu header{
	border-bottom:1px solid color-mix(in srgb,var(--dp-glass_border) 64%,transparent);
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent);
	color:var(--dp-text_muted,#475569);
}
body[data-dp-theme-effects~="glass"] .dp-panel-ajax-loading:after{
	background:linear-gradient(90deg,var(--dp-primary-600,#2563eb),var(--dp-info-600,#0891b2),var(--dp-success-600,#16a34a));
	box-shadow:0 0 22px color-mix(in srgb,var(--dp-info-600,#0891b2) 42%,transparent);
}
...
body[data-dp-theme-effects~="glass"] [tabindex]:focus-visible{
	outline:2px solid color-mix(in srgb,var(--dp-primary-600,#2563eb) 76%,#fff);
	outline-offset:3px;
	box-shadow:0 0 0 5px color-mix(in srgb,var(--dp-primary-600,#2563eb) 18%,transparent),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] textarea[aria-invalid=true]{
	border-color:color-mix(in srgb,var(--dp-danger-600,#dc2626) 62%,var(--dp-glass_border));
	background:linear-gradient(135deg,color-mix(in srgb,var(--dp-danger-600,#dc2626) 9%,var(--dp-glass_control_bg)),color-mix(in srgb,var(--dp-glass_surface_muted_bg) 58%,transparent));
	box-shadow:0 0 0 4px color-mix(in srgb,var(--dp-danger-600,#dc2626) 14%,transparent),inset 0 1px 0 color-mix(in srgb,#fff 20%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-field:has(.dp-panel-error) span,
body[data-dp-theme-effects~="glass"] .dp-panel-error{
	color:color-mix(in srgb,var(--dp-danger-700,#b42318) 88%,var(--dp-text));
	font-weight:850;
}
body[data-dp-theme-effects~="glass"] .dp-panel-error{
	display:inline-flex;
	...
	width:max-content;
	max-width:100%;
	border:1px solid color-mix(in srgb,var(--dp-danger-600,#dc2626) 28%,var(--dp-glass_border));
	border-radius:999px;
	background:color-mix(in srgb,var(--dp-danger-600,#dc2626) 10%,var(--dp-glass_surface_muted_bg));
	padding:5px 8px;
	box-shadow:var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] .dp-panel-alert,
...
body[data-dp-theme-effects~="glass"] .dp-panel-notice:before{
	...
	inset:0 auto 0 0;
	width:4px;
	background:var(--dp-glass-tone,var(--dp-primary-600,#2563eb));
	opacity:.86;
}
body[data-dp-theme-effects~="glass"] .dp-panel-alert>*,
body[data-dp-theme-effects~="glass"] .dp-panel-notice>*{
...
body[data-dp-theme-effects~="glass"] .dp-panel-action-success:focus-visible{
	...
	box-shadow:0 0 0 5px color-mix(in srgb,currentColor 24%,transparent),var(--dp-glass_edge);
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-theme-select select{
	background:color-mix(in srgb,var(--dp-glass_control_bg) 62%,transparent);
	box-shadow:var(--dp-glass_edge);
}
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-theme-select select{
	background:color-mix(in srgb,rgba(30,41,59,.76) 68%,transparent);
}
@media(prefers-color-scheme:dark){
body[data-dp-theme-mode="system"][data-dp-theme-effects~="glass"] .dp-panel-theme-select select{
	background:color-mix(in srgb,rgba(30,41,59,.76) 68%,transparent);
...
body[data-dp-theme-effects~="glass"] pre{
	border:1px solid color-mix(in srgb,var(--dp-glass_border) 74%,transparent);
	background:color-mix(in srgb,var(--dp-glass_control_bg) 82%,var(--dp-surface) 12%);
	color:var(--dp-text,#0f172a);
	box-shadow:var(--dp-glass_edge);
}
body[data-dp-theme-effects~="glass"] kbd{
...
body[data-dp-theme-effects~="glass"] .dp-panel-table tbody tr:nth-child(odd){
	background:color-mix(in srgb,var(--dp-glass_surface_muted_bg) 38%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-table tbody tr:nth-child(even){
	background:color-mix(in srgb,var(--dp-glass_surface_strong_bg) 34%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-table tbody tr:hover{
	background:linear-gradient(90deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 10%,var(--dp-glass_surface_muted_bg)),color-mix(in srgb,var(--dp-glass_surface_strong_bg) 68%,transparent));
}
...
body[data-dp-theme-effects~="glass"] .dp-panel-form-pulse-grid>*:after{
	...
	position:absolute;
	inset:0;
	background:linear-gradient(90deg,transparent,color-mix(in srgb,#fff 24%,transparent),transparent);
	transform:translateX(-100%);
	animation:dp-panel-glass-shimmer 1.45s ease-in-out infinite;
	pointer-events:none;
}
...
body[data-dp-theme-mode="dark"][data-dp-theme-effects~="glass"] .dp-panel-table tbody tr:hover{
	background:linear-gradient(90deg,color-mix(in srgb,var(--dp-primary-600,#2563eb) 20%,rgba(15,23,42,.72)),rgba(30,41,59,.56));
}
@media(prefers-color-scheme:dark){
...
body[data-dp-theme-effects~="glass"] .dp-panel-modal-header{
	background:color-mix(in srgb,var(--dp-glass_surface_strong_bg) 86%,transparent);
}
body[data-dp-theme-effects~="glass"] .dp-panel-density,
body[data-dp-theme-effects~="glass"] .dp-panel-table-groups,
body[data-dp-theme-effects~="glass"] .dp-panel-table-views,
...
@media(max-width:760px){body[data-dp-theme-effects~="glass"]{--dp-glass_blur:var(--dp-glass_mobile_blur,blur(14px) saturate(1.12));--dp-glass_shadow:var(--dp-glass_shadow_soft)}body[data-dp-theme-effects~="glass"] .dp-panel-tab-list,body[data-dp-theme-effects~="glass"] .dp-panel-step-list{border-radius:18px;overflow-x:auto}body[data-dp-theme-effects~="glass"] .dp-panel-main-region>header:after,body[data-dp-theme-effects~="glass"] .dp-panel-card:after,body[data-dp-theme-effects~="glass"] .dp-panel-widget:after,body[data-dp-theme-effects~="glass"] .dp-panel-page-table:after,body[data-dp-theme-effects~="glass"] .dp-panel-table-shell:after,body[data-dp-theme-effects~="glass"] .dp-panel-commandbar:after,body[data-dp-theme-effects~="glass"] .dp-panel-form-section:after,body[data-dp-theme-effects~="glass"] .dp-panel-show-field:after{opacity:.52}body[data-dp-theme-effects~="glass"] .dp-panel-empty-state:before{opacity:.38}}
@media(prefers-reduced-motion:reduce){body[data-dp-theme-effects~="glass"] .dp-panel-modal-loading:before,body[data-dp-theme-effects~="glass"] .dp-panel-form-loading:after,body[data-dp-theme-effects~="glass"] .dp-panel-action-loading:after{animation:none;display:none}body[data-dp-theme-effects~="glass"] .dp-panel-widget:hover,body[data-dp-theme-effects~="glass"] .dp-panel-card:hover,body[data-dp-theme-effects~="glass"] .dp-panel-show-field:hover,body[data-dp-theme-effects~="glass"] .dp-panel-board-card:hover{transform:none}}
CSS;
	}
