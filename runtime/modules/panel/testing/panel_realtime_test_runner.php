...
$test=dirname(__DIR__).'/unit_tests/dataphyre.panel_realtime_scorched_earth.test.php';
require $test;
...
$report=['type'=>'panel_realtime_unit_test_proof','php_version'=>PHP_VERSION,'cases'=>count($results),'assertions'=>array_sum(array_map(static fn(array $result): int=>(int)($result['assertions']??0),$results)),'failures'=>$failed];
