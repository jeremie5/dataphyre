...
```shell
php source-checkout-maintainer-tool generate-stubs \
...
```shell
php source-checkout-maintainer-tool check
...
```shell
php source-checkout-maintainer-tool update-contract
```
...
Run `php source-checkout-maintainer-tool dump-contract` and compare the affected class. Fix accidental PHPDoc drift; for an intentional API change, update the fixture and documentation before regenerating the contract.
