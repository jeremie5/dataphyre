...
test('Datadoc documentation CLI publishes a producer-neutral portal safely',static function(Context $t):void {
	...
	$t->notContains('Panel',(string)file_get_contents($target.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'portal.js'));
	$t->notContains('Panel',(string)file_get_contents($target.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'favicon.svg'));
