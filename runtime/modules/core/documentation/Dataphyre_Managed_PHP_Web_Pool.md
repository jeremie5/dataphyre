...
The managed pool accepts only `dataphyre.application_environment.v3`; it rejects
older envelopes and provides no dual-read or compatibility fallback.
...
The private runtime status contract is `dataphyre.application_runtime.v7`. Its
