...
final class Reactor {
	 ...
	 */
	public static function dispatch(ReactorRequest|array|null $request=null, ReactorSecurityContext|array|null $securityContext=null): ReactorResponse {
		if($securityContext!==null){ $request=ReactorRequest::from($request, $securityContext); }
	 ...
	 */
	public static function snapshot(string $component, array $state=[], ReactorSecurityContext|array|null $securityContext=null): ReactorSnapshot {
		return self::manager()->snapshot($component, $state, $securityContext);
	}
	 ...
	 */
	public static function mount(string $component, array $state=[], array $attributes=[], ReactorSecurityContext|array|null $securityContext=null): string {
		return self::manager()->mount($component, $state, $attributes, $securityContext);
	}
