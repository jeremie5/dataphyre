...
final class DpTestKitLifecycleProbe {
	public static bool $beforeAllRan=false;
}

before_all(static function(): void {
	DpTestKitLifecycleProbe::$beforeAllRan=true;
});

after_all(static function(): void {
	DpTestKitLifecycleProbe::$beforeAllRan=false;
});
...
test('snapshot and lifecycle helpers are worker local', static function(Context $t): void {
	$t->isTrue(DpTestKitLifecycleProbe::$beforeAllRan);
