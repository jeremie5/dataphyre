...
if($file=dp_module_present('internal_module')){
	require($file);
	dataphyre\internal_module::set_handler();
	function attempt($a=null){ 
		return dataphyre\internal_module::attempt($a);
	}
	function end_attempt(){ 
		return dataphyre\internal_module::end_attempt();
	}
	function define_optional($a=null,$b=null){ 
		return dataphyre\internal_module::define_optional($a,$b);
	}
}
else
{
...
if($file=dp_module_present('policy_module'))require($file);
