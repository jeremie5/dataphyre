...
if(RUN_MODE!=='diagnostic'){
	...
	if($mod=dp_module_present('internal_module')){
		require($mod[0]);
		\dataphyre\internal_module::set_handler();
		function attempt($a=null){ return \dataphyre\internal_module::attempt($a);}
		function end_attempt(){return \dataphyre\internal_module::end_attempt();}
		function define_optional($a=null,$b=null){return \dataphyre\internal_module::define_optional($a,$b);}
	}
	else
	{
